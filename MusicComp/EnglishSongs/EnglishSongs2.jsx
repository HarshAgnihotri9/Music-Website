...
function EnglishSongs2() {
  ...
  const handleme5 = async () => {
    await setmusic(
      "music/EnglishSongs/Somewhere Only We Know-(PagalWorld).mp3"
    );
    // console.log("hiiiiiljl");
  ...
  const handleme6 = async () => {
    await setmusic(
      "music/EnglishSongs/Everything Hits Me At Once-(PagalWorld).mp3"
    );
    // console.log("hiiiiiljl");
